...
The [`den.provides.mutual-provider`](https://github.com/denful/den/blob/main/modules/aspects/provides/mutual-provider.nix) battery allows you to define mutual configurations by letting you define named aspects under `.provides.` to create explicit relationships between users and hosts.
