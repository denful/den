...
[`den.batteries.mutual-provider`](https://github.com/denful/den/blob/main/modules/aspects/provides/mutual-provider.nix)
battery:
...
```nix
den.aspects.tux.igloo = { }; # user configuration for tux that should only apply on igloo
```
