...
:::tip
The [Standalone Home Manager](/guides/standalone-home-manager/) guide covers standalone homes end to end: `user@host` homes, sharing aspects with host users, defaults, and current limitations.
:::
...
[nix-maid](https://github.com/viperML/nix-maid) is another user-environment manager for NixOS.
