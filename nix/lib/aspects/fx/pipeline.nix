...
let
  ...
  fxResolve =
    ...
    let
      ...
      # Apply policy.provide — inject modules directly into target classes.
      # Runs before routes so forward-derived routes see provide-injected modules.
